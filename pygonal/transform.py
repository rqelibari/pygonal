...
class Affine(tuple):
    ...
    def translation(cls, offset):
        ...
        :type offset: :class:`~pygonal.Vec2`
        :rtype: Affine
        """
        ox, oy = offset
    ...
    def scale(cls, scaling):
        ...
        :type scaling: float or :class:`~pygonal.Vec2`
        :rtype: Affine
        """
        try:
            sx = sy = float(scaling)
    ...
    def is_rectilinear(self):
        ...
        """
        a, b, c, d, e, f, g, h, i = self
        return ((abs(a) < pygonal.EPSILON and abs(e) < pygonal.EPSILON)
            or (abs(d) < pygonal.EPSILON and abs(b) < pygonal.EPSILON))
    ...
    def is_conformal(self):
        ...
        """
        a, b, c, d, e, f, g, h, i = self
        return abs(a*b + d*e) < pygonal.EPSILON
    ...
    def is_orthonormal(self):
        ...
        return (self.is_conformal
            and abs(1.0 - (a*a + d*d)) < pygonal.EPSILON
            and abs(1.0 - (b*b + e*e)) < pygonal.EPSILON)
    ...
    def is_degenerate(self):
        ...
        cannot be inverted.
        """
        return abs(self.determinant) < pygonal.EPSILON

    @property
    def column_vectors(self):
        """The values of the transform as three 2D column vectors"""
        a, b, c, d, e, f, _, _, _ = self
        return pygonal.Vec2(a, d), pygonal.Vec2(b, e), pygonal.Vec2(c, f)
    ...
    def almost_equals(self, other):
        ...
        for i in (0, 1, 2, 3, 4, 5):
            if abs(self[i] - other[i]) >= pygonal.EPSILON:
                return False
        return True
    ...
    def __mul__(self, other):
        ...
        :type other: Affine, :class:`~pygonal.Vec2`,
            :class:`~pygonal.Vec2Array`, :class:`~pygonal.Shape`
        :rtype: Same as ``other``
        """
        ...
        if isinstance(other, Affine):
            ...
            try:
                ...
                return NotImplemented
            return pygonal.Vec2(vx*sa + vy*sd + sc, vx*sb + vy*se + sf)
    ...
    def __imul__(self, other):
        if isinstance(other, Affine) or isinstance(other, pygonal.Vec2):
            return self.__mul__(other)
        else:
            return NotImplemented
    ...
    def itransform(self, seq):
        ...
        :param seq: Mutable sequence of :class:`~pygonal.Vec2` to be
            transformed.
    ...
    def __invert__(self):
        ...
        if self.is_degenerate:
            raise pygonal.TransformNotInvertibleError(
